...
func init() {
	...
	RegisterCacheSimForModel("claude-opus", CacheSimConfig{
		...
		CacheReadJitter:     0.10,
		CacheCreationTiers: []CacheCreationTier{
			{Probability: 0.50, Rate: 0.25, Jitter: 0.20}, // 50%: 中 creation
			{Probability: 0.30, Rate: 0.30, Jitter: 0.25}, // 30%: 大 creation
			{Probability: 0.15, Rate: 0.45, Jitter: 0.30}, // 15%: 超大 creation
			// 剩余 5%：不产生 cache creation
		},
		CacheHitInputRate:  0.008,
		CacheMissInputRate: 0.05,
	...
	RegisterCacheSimForModel("claude-sonnet", CacheSimConfig{
		...
		CacheReadJitter:     0.10,
		CacheCreationTiers: []CacheCreationTier{
			{Probability: 0.50, Rate: 0.25, Jitter: 0.20},
			{Probability: 0.30, Rate: 0.30, Jitter: 0.25},
			{Probability: 0.15, Rate: 0.45, Jitter: 0.30},
		},
		CacheHitInputRate:  0.008,
		CacheMissInputRate: 0.05,
		CacheMissRate:      0.08,
	...
	RegisterCacheSimForModel("claude-haiku", CacheSimConfig{
		...
		CacheCreationTiers: []CacheCreationTier{
			{Probability: 0.50, Rate: 0.30, Jitter: 0.20},
			{Probability: 0.30, Rate: 0.40, Jitter: 0.25},
			{Probability: 0.15, Rate: 0.50, Jitter: 0.30},
		},
		CacheHitInputRate:  0.008,
