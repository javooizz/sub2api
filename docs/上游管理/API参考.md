...
```jsonc
{
  ...
  "proxy_id": null, "balance_threshold": 5.0, "notify_on_price_change": true,
...
```jsonc
{
  ...
  "proxy_id": null, "balance_threshold": 99999999,
...
```jsonc
{ "browser_cdp_url": "ws://127.0.0.1:9222", "allow_private_webhook": false }
```
