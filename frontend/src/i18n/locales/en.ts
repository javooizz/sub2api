export default {
  ...
  nav: {
    ...
    upstreamManagement: 'Upstream Providers',
  },
  ...
  modelPlaza: {
    ...
    filters: {
      ...
      requiresSubscription: 'Subscription required',
    },
    billingMode: {
      token: 'Pay per token',
    ...
    card: {
      ...
      multiplierBadge: '{multiplier}x',
      userRateBadge: 'Personal rate',
      noPricing: 'Pricing not configured',
      dynamicTiers: 'Dynamic pricing, {count} tiers',
      groupCount: '{count} groups available',
    },
    pricing: {
      input: 'Input',
      output: 'Output',
    ...
    disabled: 'Model Plaza is not enabled',
