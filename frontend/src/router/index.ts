...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/admin/extension-configs/model-catalog',
    name: 'AdminExtensionConfigModelCatalog',
    component: () => import('@/views/admin/ExtensionConfigModelCatalogView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Extension Configs Model Catalog',
      titleKey: 'admin.extensionConfig.modelCatalog.title',
      descriptionKey: 'admin.extensionConfig.modelCatalog.description'
    }
  },
  {
